    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mWeekView.setEventDrawListener(new WeekView.EventDrawListener() {
            ...
            public void onDrawEvent() {
                ...
                Calendar endTime = WeekViewUtil.today();
                startTime.set(Calendar.DATE,mDayOfWeek);
                endTime.set(Calendar.DATE,mDayOfWeek);
        ...
        mWeekView.setSelectDayOfWeekListener(new WeekView.SelectedDayOfMonthListener() {
            @Override
            public void onSelectedDayOfMonth(int dayOfWeek) {
        ...
        mWeekView.setEventLongPressListener(new WeekView.EventLongPressListener() {
            ...
            public void onEventLongPress(WeekViewEvent event, RectF eventRect, Calendar currentChangeTime, int startOrEndTime) {
                Log.e("onEventLongPress: ",currentChangeTime.getTime().getMonth()+" "+currentChangeTime.getTime().getDate());
